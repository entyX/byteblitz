...
// Burst problem set.
//
// Problems live in six CSVs (one per tier), generated by tools/build_questions.py
// from the authored question sets. Each row is one problem: statement, input
// format, constraints, a worked sample, and twelve judged test cases. Tiers are
...
const CSV_PATH = {
  Bronze:   "/data/burst_bronze.csv",
  Silver:   "/data/burst_silver.csv",
  Gold:     "/data/burst_gold.csv",
  Platinum: "/data/burst_platinum.csv",
  Diamond:  "/data/burst_diamond.csv",
  Master:   "/data/burst_master.csv",
};
...
export const TESTS_PER_PROBLEM = 12;
