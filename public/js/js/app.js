...
function buildShell() {
  const nav = h("nav", { class: "nav" },
    h("div", { class: "nav-inner" },
      h("a", { class: "logo", href: "#/" }, "Byte", h("span", { class: "accent" }, "Blitz"), h("span", { class: "logo-version" }, "v1.3 [C3 BETA]")),
      navLinks,
...
route("/share/:id", renderPublicAnalysis);
route("/analysis/duel/:id", renderDuelAnalysis);
route("/analysis/:uid/:archetypeId", renderPrivateAnalysis);
