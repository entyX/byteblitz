...
export function renderChangelog(params, root) {
  ...
  page.append(
    ...
    h("p", { class: "body-text mb-8", style: { maxWidth: "700px" } },
      "A player-focused record of what has changed in each public ByteBlitz version."),
    h("div", { class: "change-list" }, RELEASES.map((release) =>
      h("article", { class: "change-card" + (release.current ? " current" : "") },
